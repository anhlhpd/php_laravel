...
<body>
    <nav class="navbar navbar-light bg-light">
        ...
        <div class="col-md-2 mt-3">
            <div>
                <a href="/change-language/vi" class="img-thumbnail m-1"><img src="{{asset('img/vietnam.jpg')}}"></a>
                <a href="/change-language/en" class="img-thumbnail m-1"><img src="{{asset('img/united-kingdom.jpg')}}"></a>
            </div>
